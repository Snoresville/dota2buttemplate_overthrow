...
BUTTINGS.ALT_WINNING.ALT_KILL_LIMIT.VALUE = OVERTHROW_KILL_LIMITS[GetMapName()] or OVERTHROW_KILL_LIMITS["default"]

if IsInToolsMode() then 
	BUTTINGS.OVERTHROW_EXCLUSIVE.USE_BOTS.VALUE = 1 
	BUTTINGS.ALT_WINNING.ALT_KILL_LIMIT.VALUE = 100
	BUTTINGS.ALT_WINNING.ALT_TIME_LIMIT.VALUE = 10
end
