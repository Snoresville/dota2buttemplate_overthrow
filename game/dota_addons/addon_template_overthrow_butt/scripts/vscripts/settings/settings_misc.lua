ListenToGameEvent("created_game_mode_entity",function()
	...
	--GameRules:SetHeroSelectionTime( 90 )						-- (doesn't work)
	gameModeEnt:SetDraftingHeroPickSelectTimeOverride( 90 )		-- Sets the amount of time players have to pick their hero. 
